...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 mx-auto max-w-md">
      <div className="m-3 rounded-2xl bg-card/95 backdrop-blur shadow-2xl border border-white/5">
              ...
              return (
                <li key={it.href} className="flex items-center justify-center">
                  <Link
                    href={it.href}
                    aria-label={it.label}
                    className="-mt-6 flex h-14 w-14 items-center justify-center rounded-full bg-accent text-white text-2xl shadow-lg active:scale-95"
                  >
                    {it.icon}
                  </Link>
                </li>
